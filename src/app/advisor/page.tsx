  ...
  return (
    <main className="mx-auto w-full max-w-md flex-1 px-6 py-12">
      ...
      <div className="mt-6 space-y-4">
        ...
        <button
          onClick={submit}
          disabled={busy || (mode === "register" && !registerValid)}
        ...
        {mode === "login" && (
          <button onClick={forgotPassword} disabled={busy} className="w-full text-center text-xs text-neutral-500 hover:text-sky-700 disabled:opacity-50 dark:hover:text-sky-400">
            忘記密碼?
          </button>
        )}
      </div>
