    ...
    data: {
      ...
      core: {
        ...
        assets: {
          ...
          forex: { has: true, amount: 40 }, gold: { has: true, amount: 30 }, crypto: { has: true, amount: 30 }, retire_account: { has: true, amount: 80 },
      ...
      deep: {
        ...
        children_insurance: [
          { life: { has: false, coverage: 0 }, critical_illness: { has: false, coverage: 0 }, cancer_lump: { has: true, coverage: 30 }, accident: { has: true, coverage: 100 }, medical: { has: true, daily: 2000, reimburse_limit: 10 }, cancer_hospital: { has: false, daily: 0 }, disability: { has: false, monthly: 0 } },
          { life: { has: false, coverage: 0 }, critical_illness: { has: false, coverage: 0 }, cancer_lump: { has: false, coverage: 0 }, accident: { has: true, coverage: 100 }, medical: { has: true, daily: 1500, reimburse_limit: 10 }, cancer_hospital: { has: false, daily: 0 }, disability: { has: false, monthly: 0 } },
        ],
      },
    ...
    data: {
      ...
      core: {
        ...
        assets: {
          ...
          forex: { has: false, amount: 0 }, gold: { has: false, amount: 0 }, crypto: { has: false, amount: 0 }, retire_account: { has: false, amount: 0 },
          other: { has: false, amount: 0 },
        },
      },
    ...
    data: {
      ...
      core: {
        ...
        assets: {
          ...
          forex: { has: false, amount: 0 }, gold: { has: false, amount: 0 }, crypto: { has: true, amount: 8 }, retire_account: { has: false, amount: 0 },
          other: { has: false, amount: 0 },
        },
      },
    },
